...
def rebuild_model_after_task_update():
    ...
    if len(X) == 0:
        print("⚠ No tasks available. Model not updated.")
        return
    ...
    print("✓ Model was updated after task modification")

if __name__ == "__main__":
    rebuild_model_after_task_update()
